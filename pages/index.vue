<template>
    <div>
        ...
        <div class='mt-5 lg:mt-7 xl:mt-12'>
            ...
            <div class='grid grid-cols-2 sm:grid-cols-2 xl:grid-cols-4 gap-x-6 gap-y-12 mt-7'>
                <div v-for='(item,index) in menu' :key='index'
                     class='border border-gray-1 text-gray-1 rounded-lg flex justify-center py-14 relative cursor-pointer transform transition duration-300 ease-in-out hover:-translate-y-3 hover:text-[#dca93d] hover:border-[#dca93d]'>
                    <svg-icon
                        :name='item.icon'
                        class='w-[40px] h-[40px] md:w-[100px] md:h-[100px] xl:w-[140px] xl:h-[140px]'
                    />
                    <div class='absolute -bottom-4 sm:-bottom-6'>
                        <button class='text-white bg-gray-1 text-sm md:text-xl rounded-full px-7 py-2 hov'>
                            {{ item.name }}
                        </button>
                    </div>
                </div>
