    ...
    <div
        ...
        <div
            ...
            <div class='relative mx-auto'>
                <div class='bg-[#1E1E1E] min-h-full max-h-[40rem] w-full overflow md:w-[30rem] rounded-lg px-7 py-4'>
                    ...
                    <div>
                        ...
                        <button class='w-full font-light mt-3 text-white bg-[#53A451] py-2 rounded-full'>
                            รับการแจ้งเตือน ฝาก-ถอน ผ่าน LINE
                        </button>

                        <button @click='report = !report'
                                class='w-full font-light mt-3 text-white bg-[#FF4359] py-2 rounded-full'>
                        ...
                        <div v-if='report' class='mt-5 bg-[#242424] rounded-lg p-4'>
                            ...
                            <button
                                class='bg-gradient-to-b from-gold-1 to-gold-2 px-5 py-2 text-white rounded-full w-full mt-5'>
                                ยืนยัน
                            </button>
                        </div>
                    </div>
